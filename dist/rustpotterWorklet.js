    ...
    */
    ...
    async function init(input) {
        if (typeof input === 'undefined') {
            input = new URL('rustpotter_wasm_bg.wasm', (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('rustpotterWorklet.js', document.baseURI).href)));
        }
